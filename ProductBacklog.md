...
### Survey 
> - As a patient, I should be able to complete a survey (select all the symptoms, leave additional comment) multiple times and get a response from the system based on the survey report that has been completed.
