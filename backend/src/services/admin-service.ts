...
export const AdminService = {
   ...
   async create(adminDto: {
      ...
      if (found) throw ApiError.BadRequest('Admin account with this email already exists')
   ...
   async update(adminDto: {
      ...
      if (adminDto.password) admin.password = await bcrypt.hash(adminDto.password, 10)
