...
> The patient will be able to use this tool to self-assess their current condition or situation if they are feeling ill, to provide more information as a reason for booking an appointment with the doctor. Base on the information provided the system will red-flagging their request, base on the number of symptoms that patient might have or critical symptoms might have. 
